...
$preparestring2 = pg_prepare($conn, 'update1', 'UPDATE cart SET (hetzner_starter, hetzner_plus, hetzner_advanced, subtotal) = ($1, $2, $3, $4, $5) WHERE email = $6');
$result2 = pg_execute($conn, 'update1', array($hetzner_starter, $hetzner_plus, $hetzner_advanced, $subtotal, $email));
$returnobj = new \stdClass();
